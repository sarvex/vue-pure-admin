import{t as V}from"./data-3e2c6489.js";import{d as K,r as f,s as U,W as H,af as G,p as Q,q as X,c as m,e as c,F as M,l as I,aK as O,m as k,an as z,T as Y,aq as g,f as x,y as T,aA as Z,n as A,bu as ee,B as ne,bv as te,J as ae}from"./index-b37327d6.js";import{m as ie}from"./message-da7500cf.js";/*! *****************************************************************************
...
***************************************************************************** */function N(e,u,a,_){function o(p){return p instanceof a?p:new a(function(n){n(p)})}return new(a||(a=Promise))(function(p,n){function v(b){try{w(_.next(b))}catch(y){n(y)}}function d(b){try{w(_.throw(b))}catch(y){n(y)}}function w(b){b.done?p(b.value):o(b.value).then(v,d)}w((_=_.apply(e,u||[])).next())})}function _e(e,u,a){let _=document.createElement(e);return _.setAttribute("class",u),a&&(_.innerText=a),_}const R=function(e){let u=Array.isArray(e)?[]:{};if(e&&typeof e=="object")for(let a in e)e.hasOwnProperty(a)&&(e[a]&&typeof e[a]=="object"?u[a]=R(e[a]):u[a]=e[a]);return u};var C=K({name:"MouseMenu",props:{appendToBody:{type:Boolean,default:!0},menuWidth:{type:Number,default:200},menuList:{type:Array,required:!0},menuHiddenFn:{type:Function},hasIcon:{type:Boolean,default:!1},iconType:{type:String,default:"font-icon"},menuWrapperCss:Object,menuItemCss:Object,el:{type:Object,required:!0},params:{type:[String,Number,Array,Object]},useLongPressInMobile:Boolean,longPressDuration:Number,injectCloseListener:{type:Boolean,default:!0},customClass:String,disabled:{type:Function}},setup(e){const u=f(0),a=f(0),_=f(!1),o=f(0),p=f(0),n=f(!1),v=f(null),d=f([]),w=U(()=>e.menuList.some(i=>i.children&&i.children.length>0)),b=f(10),y=f();H(n,i=>N(this,void 0,void 0,function*(){var r,s;if(i){yield A();let l=y.value;e.menuWrapperCss&&Object.keys(e.menuWrapperCss).map(h=>{l.style.setProperty(`--menu-${h}`,e.menuWrapperCss&&e.menuWrapperCss[h])}),e.menuItemCss&&Object.keys(e.menuItemCss).map(h=>{l.style.setProperty(`--menu-item-${h}`,e.menuItemCss&&e.menuItemCss[h])});let t=(s=(r=e.menuItemCss)===null||r===void 0?void 0:r.arrowSize)===null||s===void 0?void 0:s.match(/\d+/);t?b.value=~~t[0]||10:b.value=10,l.style.setProperty("--menu-item-arrowRealSize",b.value/2+"px")}}));const q=(i,r)=>{i.disabled||(i.fn&&typeof i.fn=="function"&&i.fn(e.params,v.value,e.el,r),n.value=!1)},j=(i,r)=>{i.disabled||(i.fn&&typeof i.fn=="function"&&!i.disabled&&(i.fn(e.params,v.value,e.el,r),_.value=!1),n.value=!1)},D=(i,r)=>{if(r.children&&!r.disabled){_.value=!0;const s=i.currentTarget;if(!s)return;const{offsetWidth:l}=s,t=s.querySelector(".__menu__sub__wrapper");if(!t)return;const{offsetWidth:h,offsetHeight:S}=t,{innerWidth:J,innerHeight:$}=window,{top:B,left:W}=s.getBoundingClientRect();W+l+h>J-5?u.value=W-h+5:u.value=W+l,B+S>$-5?a.value=$-S:a.value=B+5}},F=(i,r,s,l)=>i.map(t=>(t.children&&(t.children=F(t.children,r,s,l)),t.label&&typeof t.label=="function"&&(t.label=t.label(l,r,s)),t.tips&&typeof t.tips=="function"&&(t.tips=t.tips(l,r,s)),t.icon&&typeof t.icon=="function"&&(t.icon=t.icon(l,r,s)),t.hidden&&typeof t.hidden=="function"&&(t.hidden=t.hidden(l,r,s)),t.disabled&&typeof t.disabled=="function"&&(t.disabled=t.disabled(l,r,s)),t)),E=(i=0,r=0)=>N(this,void 0,void 0,function*(){if(v.value=document.elementFromPoint(i-1,r-1),e.menuHiddenFn?n.value=!e.menuHiddenFn(e.params,v.value,e.el):n.value=!0,!n.value)return;d.value=R(e.menuList),d.value=F(d.value,v.value,e.el,e.params),yield A();const{innerWidth:s,innerHeight:l}=window,h=y.value.offsetHeight,S=e.menuWidth||200;p.value=i+S+1>s?s-S-5:i+1,o.value=r+h+1>l?l-h-5:r+1}),P=()=>{n.value=!1},L=i=>{y.value&&!y.value.contains(i.currentTarget)&&(n.value=!1,document.oncontextmenu=null)};return H(()=>e.injectCloseListener,i=>{i?document.addEventListener("mousedown",L):document.removeEventListener("mousedown",L)},{immediate:!0}),G(()=>{document.removeEventListener("mousedown",L)}),{subLeft:u,subTop:a,hoverFlag:_,menuTop:o,menuLeft:p,showMenu:n,clickDomEl:v,calcMenuList:d,arrowSize:b,hasSubMenu:w,MenuWrapper:y,handleMenuItemClick:q,handleSubMenuItemClick:j,handleMenuMouseEnter:D,show:E,close:P}}});const oe=ee();Q("data-v-3d21bc0a");const ue={key:0,class:"__menu__item-icon"},de={class:"__menu__item-label"},re={class:"__menu__item-tips"},se={class:"__menu__item-arrow-after"},le={class:"__menu__sub__item-label"},me={class:"__menu__sub__item-tips"};X();const ce=oe((e,u,a,_,o,p)=>(m(),c(Z,{to:"body",disabled:!e.appendToBody},[e.showMenu?(m(),c("div",{key:0,ref:"MenuWrapper",class:["__menu__wrapper",e.customClass],style:{width:`${e.menuWidth}px`,top:`${e.menuTop}px`,left:`${e.menuLeft}px`}},[(m(!0),c(M,null,I(e.calcMenuList,(n,v)=>(m(),c(M,null,[!n.hidden&&!n.line?(m(),c("div",{key:v,class:["__menu__item",n.disabled&&"disabled",n.customClass],onMousedown:O(d=>e.handleMenuItemClick(n,d),["stop"]),onMouseenter:d=>e.handleMenuMouseEnter(d,n)},[e.hasIcon?(m(),c("div",ue,[e.iconType==="font-icon"?k((m(),c("i",{key:0,class:n.icon},null,2)),[[z,n.icon]]):e.iconType==="svg-icon"?k((m(),c("div",{key:1,class:"__menu__item-icon-svg",innerHTML:n.icon},null,8,["innerHTML"])),[[z,n.icon]]):e.iconType==="vnode-icon"?(m(),c(Y(n.icon),{key:2})):g("v-if",!0)])):g("v-if",!0),x("span",de,T(n.label),1),x("span",re,T(n.tips||""),1),e.hasSubMenu?(m(),c("span",{key:1,class:["__menu__item-arrow",{show:e.hasSubMenu&&n.children}],style:{width:e.arrowSize+"px",height:e.arrowSize+"px"}},[k(x("span",se,null,512),[[z,e.hasSubMenu&&n.children]])],6)):g("v-if",!0),n.children&&n.children.length>0?k((m(),c("div",{key:2,class:"__menu__sub__wrapper",style:{top:`${e.subTop}px`,left:`${e.subLeft}px`}},[(m(!0),c(M,null,I(n.children,(d,w)=>(m(),c(M,null,[!d.hidden&&!d.line?(m(),c("div",{key:w,class:["__menu__sub__item",d.disabled&&"disabled",d.customClass],onMousedown:O(b=>e.handleSubMenuItemClick(d,b),["stop"])},[x("span",le,T(d.label),1),x("span",me,T(d.tips||""),1)],42,["onMousedown"])):g("v-if",!0),d.line?(m(),c("div",{key:w,class:"__menu__line"})):g("v-if",!0)],64))),256))],4)),[[z,e.hoverFlag]]):g("v-if",!0)],42,["onMousedown","onMouseenter"])):g("v-if",!0),!n.hidden&&n.line?(m(),c("div",{key:v,class:"__menu__line"})):g("v-if",!0)],64))),256))],6)):g("v-if",!0)],8,["disabled"])));function be(e,u){u===void 0&&(u={});var a=u.insertAt;if(!(!e||typeof document>"u")){var _=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css",a==="top"&&_.firstChild?_.insertBefore(o,_.firstChild):_.appendChild(o),o.styleSheet?o.styleSheet.cssText=e:o.appendChild(document.createTextNode(e))}}var ve=`.__menu__mask[data-v-3d21bc0a] {
  position: fixed;
  top: 0;
  left: 0;
  bottom: 0;
